	...
	background-color: #ffffff;
		...
		<form:form action="${pageContext.request.contextPath}/user/add"
			...
			<table>
				...
				<tr>
					<td>House Number</td>
					<td><form:input path="billingAddress.house_no" id="house_no" /></td>
				</tr>
				<tr>
					<td>Street Name/Number</td>
					<td><form:input path="billingAddress.street_name" id="street_name" /></td>
				</tr>
				<tr>
					<td>Society</td>
					<td><form:input path="billingAddress.society" type = "text" /></td>
				</tr>
				<tr>
					<td>City</td>
				...
				<tr>
					<td>Zip/Pin Code</td>
					<td><form:input path="billingAddress.zip_code" /></td>
				</tr>	
				</table>
			<hr color="black">
			<table>
				...
				<tr>
					<td>House Number</td>
					<td><form:input path="shippingAddress.house_no" id="house_no" /></td>
				</tr>
				<tr>
					<td>Street Name/Number</td>
					<td><form:input path="shippingAddress.street_name" id="street_name" /></td>
				</tr>
				<tr>
					<td>Society</td>
					<td><form:input path="shippingAddress.society" type = "text" /></td>
				</tr>
				<tr>
					<td>City</td>
				...
				<tr>
					<td>Zip/Pin Code</td>
					<td><form:input path="shippingAddress.zip_code" /></td>
				</tr>	
				</table>
