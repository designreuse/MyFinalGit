        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <%--           <div class="row">
                        	...
                        	<div class="col-xs-6 col-sm-6 " > <address> ${login.image} </address></div>
                        </div>
 --%>
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="row">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                    	<td class="col-md-8"> <em> ${login.user_id }</em>
                                    	<td></td>
                                    	
                                        <td class="col-md-2" style="text-align: center"><em>${login.user_name}</em></td>
                                        <td class="col-md-1" style="text-align: center">${login.email_id}</td>
