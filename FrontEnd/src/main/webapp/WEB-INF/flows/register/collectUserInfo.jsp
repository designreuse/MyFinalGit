...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <form:input path="user_name" id="name" class="form-Control" />
        </div>

        <div class="form-group">
            <label for="email">Email</label>
            <form:input path="email_id" id="email" class="form-Control" />
        </div>

        <div class="form-group">
            <label for="phone">Phone</label>
            <form:input path="mobile_no" id="phone" class="form-Control" />
        </div>
