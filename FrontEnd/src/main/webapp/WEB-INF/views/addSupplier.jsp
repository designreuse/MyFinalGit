...
<h1>Add a Supplier</h1>
		...
		<form:form action="${pageContext.request.contextPath}/admin/supplier/add"
			...
			<table>
				...
				<tr>
					<td>Supplier Name</td>
					<td><form:input required="true" path="supplier_name" id="supplier_name" /></td>
					<td><form:errors path="supplier_name" cssClass="error">Name</form:errors></td>
				</tr>
				<tr>
					<td>Email</td>
					<td><form:input required="true" path="supplier_email" /></td>
					<td><form:errors path="supplier_email" cssClass="error"></form:errors></td>
				</tr>
				
				<tr>
					<td>Mobile Number</td>
					<td><form:input required="true" path="supplier_mobile_no" /></td>
