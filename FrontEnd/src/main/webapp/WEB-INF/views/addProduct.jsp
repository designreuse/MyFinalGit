	...
	background-color: #ffffff;
		...
		<form:form action="${pageContext.request.contextPath}/admin/product/add"
			...
			<table>
				...
				<tr>
					<td>Name</td>
					<td><form:input required="true" path="name" id="name" /></td>
					<td><form:errors path="name" cssClass="error">Name</form:errors></td>
				</tr>
				<tr>
					<td>Price</td>
					<td><form:input required="true" path="price" /></td>
			...
			<tr>
				...
				<tr>
					<td>Brand</td>
					<td><form:input required="true" path="brand" /></td>
				...
				<tr>
					...
					<td><form:input id="image" type="file" path="image" /></td>
				</tr>
				<tr>
